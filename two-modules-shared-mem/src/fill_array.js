...
var FILL_ARRAY_MODULE = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(FILL_ARRAY_MODULE) {
  FILL_ARRAY_MODULE = FILL_ARRAY_MODULE || {};
...
var Module = typeof FILL_ARRAY_MODULE !== 'undefined' ? FILL_ARRAY_MODULE : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fill_array')) {
        Object.defineProperty(Module['ready'], '_fill_array', { configurable: true, get: function() { abort('You are getting _fill_array on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fill_array', { configurable: true, set: function() { abort('You are setting _fill_array on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'fill_array.wasm';
...
var ASM_CONSTS = {
  1032: function($0) {console.log("in function fill_array, arr[i] is " + $0)}
};
...
/** @type {function(...*):?} */
var _fill_array = Module["_fill_array"] = createExportWrapper("fill_array");
...
run();
  ...
  return FILL_ARRAY_MODULE.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = FILL_ARRAY_MODULE;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return FILL_ARRAY_MODULE; });
else if (typeof exports === 'object')
  exports["FILL_ARRAY_MODULE"] = FILL_ARRAY_MODULE;
